    ...
    <div className="relative isolate flex flex-col sm:flex-row gap-y-4 sm:gap-x-6 overflow-hidden bg-gray-50 px-6 py-4 sm:py-2.5">
      ...
      <div className="flex flex-1 items-center justify-between">
        ...
        <div className="flex flex-col sm:flex-row gap-y-2 sm:gap-x-4">
          ...
          <Link
            href="/scan"
            className="bg-green-500 text-white text-sm sm:text-base px-4 py-2 rounded-md hover:bg-green-600"
          >
            Scan QR Code
          </Link>
        </div>
